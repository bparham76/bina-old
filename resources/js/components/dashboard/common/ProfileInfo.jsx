...
const ProfileInfo = () => {
    ...
    useEffect(() => {
        if (response != null) {
            ...
            if (response.pid && response.pid.length == 10) setPidEdit(false);
        }
    }, [response]);
            ...
            {loading ? (
                ...
                <>
                    ...
                    <DashboardPagePart>
                        ...
                        >
                            به منظور استفاده از خدمات مختص مشتریان حقوقی، داشتن
                            شماره اقتصادی الزامی است.
                        </Typography>
                    </DashboardPagePart>
                    <DashboardPagePart>
                        ...
                        />
                        <Typography variant="p" sx={{ fontSize: "0.8rem" }}>
                            ارائه شماره شبا معتبر به منظور انجام مراودات بانکی
                            همانند برگشت وجه مابه التفاوت سفارشات ثبت شده،
                            الزامی است.
                        </Typography>
                    </DashboardPagePart>
                    {!mobile && (
                    ...
                    <DashboardPagePart>
                        <Button
                            ...
                            disabled={
                                edit &&
                                profileInfoCompare(info, infoOrigin.current)
                                    ? true
                                    : false
                            }
                            sx={{
