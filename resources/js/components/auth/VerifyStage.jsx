import { Stack, Typography, TextField, Button, Fade } from "@mui/material";
    ...
    return (
        <Fade in={true} timeout={700}>
            <Stack spacing={1} sx={{ dispaly: "flex", alignItems: "center" }}>
                ...
                >
                    کد تاییدی به شماره تلفن همراه شما ارسال شده است. لظفا برای
                    ورود به پروفایل کاربری خود، آن را وارد کنید.
                </Typography>
                <TextField
                    id="mytextfield"
                    variant="outlined"
